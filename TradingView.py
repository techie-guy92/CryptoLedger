...
def fetchCoinsData(timeframe):
    ...
    symbols = [
        ...
        "BINANCE:AVAXUSDT-AVAXUSDT", "BINANCE:AAVEUSDT-AAVEUSDT"  , "BINANCE:LTCUSDT-LTCUSDT"    , "BINANCE:XMRUSDT.P-XMRUSDT"  , "BINANCE:NEARUSDT-NEARUSDT", 
        ...
        "BINANCE:SHIBUSDT-SHIBUSDT", "BINANCE:FLOKIUSDT-FLOKIUSDT", "BINANCE:PEPEUSDT-PEPEUSDT"  , 
