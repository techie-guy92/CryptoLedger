# Creyptoledger Monitoring Setup Guide

## **Overview**
This guide documents the complete monitoring stack setup for Creyptoledger, including Prometheus, Grafana, Alertmanager, and various exporters for Django, and PostgreSQL

## **Architecture**

```
┌────────────────────────────────────────────────────────────────┐
│                  Creyptoledger Monitoring                      │
├──────────────────┬──────────────────┬──────────────────────────┤
